...
/**
* @file encoder_links.cpp
* @brief Dieses file beinhaltet die linkslaufISR()
*
...
/**
*
* Interrupt Sub Rutine zur auswertung des Encoders (linke drehbewegung). \n
* 
...
*     mit der Bitweisen verundung von einer 12 mit dem linksFlag. \n
